const { createPrompt } = require('./commands-compositor/create-prompt.func');
...
const findPosts = {
    ...
    args:  {
        "query": {
            type: 'string',
            description: "related to worlds about, meaning, containing"
        },
        "returnMetadataFields": {
            type: "array",
            desscription: "all the variables that need to be extracted from the table"
        }
    },//"{query: str , returnMetadataFields: list}",
    input: {
        type: "",
        description: ""
    },
...
const getProfileData = {
    ...
    args: {
        profileId: {
            type: 'string',
            description: "profileId, usually found in publications data"
        }
    },//"{profileId: str, informationRequired: list}",
    inputData: {
        type: "any",
        descriptions: ""
    },
    ...
    output: {
        type: "object",
        descriptions: "JSON of a single profile"
    }
};
